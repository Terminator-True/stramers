<template>
  <div class="min-h-screen p-4 pt-20 text-white bg-gray-900">
    <button @click="$inertia.visit(route('deck.list'))" class="absolute flex items-center gap-2 px-6 py-3 font-bold text-white transition-all duration-200 transform rounded-lg shadow-lg top-6 left-6 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 hover:scale-105">
